  ...
  describe '#accept!' do
    context 'without existing acceptance' do
      ...
      it "will write to gitis" do
        expect(fake_gitis.backend).to have_received(:create_entity).with \
          cpp_entity_path,
    ...
    context 'with existing acceptance' do
      ...
      before do
        ...
        allow(fake_gitis.backend).to receive(:create_entity).and_call_original
      ...
      it "will write to gitis" do
        expect(fake_gitis.backend).not_to have_received(:create_entity)
      end
    end
  end
end
