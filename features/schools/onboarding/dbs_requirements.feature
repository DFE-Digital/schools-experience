Feature: DBS requirements
  ...
  Scenario: Completing step choosing yes
    Given I am on the 'DBS requirements' page
    And I choose 'Yes - Outline your DBS requirements' from the 'Do candidates need to have or get a DBS check?' radio buttons
  ...
  Scenario: Completing step choosing yes - when in school
    Given I am on the 'DBS requirements' page
    And I choose 'Yes - only when in school - outline your DBS requirements' from the 'Do candidates need to have or get a DBS check?' radio buttons
  ...
  Scenario: Completing step choosing no
    Given I am on the 'DBS requirements' page
    And I choose 'No - Candidates will be accompanied at all times when in school' from the 'Do candidates need to have or get a DBS check?' radio buttons
    When I submit the form
    Then I should be on the 'candidate requirements choice' page
