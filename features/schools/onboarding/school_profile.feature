Feature: School Profile
  ...
  Scenario: Viewing the profile
    ...
    Then the page should have the following summary list information:
      ...
      | Disability and access needs               | We offer facilities and provide an inclusive environment for students,\r staff and school experience candidates with disability and access needs.\r \r We're happy to discuss your disability or access needs before or as part\r of your school experience request. |
