Feature: Check if my details are already held
    ...
    Scenario: Page contents
        Given I am on the 'Check if we already have your details' page for my school of choice
    ...
    Scenario: Submitting my data
        ...
        Then I should be on the 'candidate address' page for my school of choice
