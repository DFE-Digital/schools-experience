Feature: Previewing my application
    ...
    Scenario: Page contents (when the school has flexible availability)
        ...
        Then I should see the following summary rows:
            ...
            | Experience availability                       | Epiphany to Whitsunday                                  | /candidates/schools/123456/registrations/availability_preference/edit#candidates_registrations_availability_preference_availability_container  |
