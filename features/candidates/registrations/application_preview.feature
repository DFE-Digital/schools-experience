Feature: Previewing my application
    ...
    Scenario: Page contents (when the school has flexible availability)
        ...
        Then I should see the following summary rows:
            ...
            | Email address                  | test@example.com                                        | /candidates/schools/123456/registrations/personal_information/edit#candidates_registrations_personal_information_email_container             |
