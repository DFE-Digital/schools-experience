...
seleniumHubEndpoint="http://#{ENV['SELENIUM_HUB_HOSTNAME']}:#{seleniumHubPort}/wd/hub"
if ENV['SELENIUM_HUB_ENDPOINT'].present?
  seleniumHubEndpoint=ENV['SELENIUM_HUB_ENDPOINT']
end
