def path_for(descriptor, school: nil, placement_date_id: nil, booking_id: nil,
  ...
  mappings = {
    ...
    "placement preference" => [:new_candidates_school_registrations_placement_preference_path, school],
    "availability preference" => [:new_candidates_school_registrations_availability_preference_path, school],
    ...
    "candidates dashboard" => [:candidates_dashboard_path],
    ...
    "cancelled bookings" => [:schools_cancelled_bookings_path],
    ...
    "cancelled booking" => [:schools_cancelled_booking_path, booking_id],
    ...
    "candidate experience schedule" => [:new_schools_on_boarding_candidate_experience_schedule_path],
    "candidate dress code" => [:new_schools_on_boarding_candidate_dress_code_path],
    "candidate parking information" => [:new_schools_on_boarding_candidate_parking_information_path],
    "progress" => [:schools_on_boarding_progress_path],
    ...
    "placement dates" => [:schools_placement_dates_path, placement_date_id],
    "new placement date" => [:new_schools_placement_date_path],
    "edit placement date" => [:edit_schools_placement_date_path, placement_date_id],
    "new placement details" => [:new_schools_placement_date_placement_detail_path, placement_date_id],
    ...
    "new recurrences selection" => [:new_schools_placement_date_recurrences_selection_path, placement_date_id],
    "new review recurrences" => [:new_schools_placement_date_review_recurrences_path, placement_date_id],
    "new publish dates" => [:new_schools_placement_date_publish_dates_path, placement_date_id],
    "experience outline" => [:new_schools_on_boarding_experience_outline_path],
    "teacher training" => [:new_schools_on_boarding_teacher_training_path],
    "admin contact" => [:new_schools_on_boarding_admin_contact_path],
    "profile" => [:schools_on_boarding_profile_path],
    "profile preview" => [:schools_on_boarding_preview_path],
  ...
  (path = mappings[descriptor.downcase]) ? send(*path) : raise("No mapping for #{descriptor}")
end
