def path_for(descriptor, school: nil, placement_date_id: nil, booking_id: nil, placement_request: nil)
  ...
  mappings = {
    ...
    "placement request" => [:schools_placement_request_path, placement_request&.id],
    "accept placement request" => [:schools_placement_request_accept_path, placement_request&.id],
