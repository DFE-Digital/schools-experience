def path_for(descriptor, school: nil)
  ...
  mappings = {
    ...
    "check if we already have your details" => [:new_candidates_school_registrations_contact_information_path, school],
    "candidate address" => [:new_candidates_school_registrations_contact_information_path, school],
