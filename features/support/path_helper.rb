def path_for(descriptor, school: nil, placement_date_id: nil, booking_id: nil,
  ...
  mappings = {
    ...
    "verify your email" => [:candidates_school_registrations_sign_ins_path, school],
    "verify your email with token" => [:candidates_school_registrations_sign_in_path, school, session_token],
