...
Given("I have filled in the form with accurate data") do
  fill_in "Enter what you want to get out of your placement", with: "I love teaching"
end
...
Given("the school I'm applying to is not flexible on dates") do
  ...
  (1..3).each { |i| i.weeks.from_now }.each do |date|
    @school.bookings_placement_dates.create!(date: date.weeks.from_now, published_at: 1.week.ago, supports_subjects: true, virtual: false)
