...
Then("the main service header should be {string}") do |title_text|
  expect(page).to have_css(
    ".govuk-service-navigation .govuk-width-container .govuk-service-navigation__container .govuk-service-navigation__service-name",
    text: title_text
  )
end
